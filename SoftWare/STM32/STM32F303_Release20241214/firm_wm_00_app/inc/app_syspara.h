...
typedef enum HX711SystemParaType
{
	...
	HX711SystemPara_u32_CaiJiWanChengBoBaoShengGuangKongEn=44,/**< 采集完成声光控使能*/
	HX711SystemPara_u32_CaiJiWanChengBoBaoCiShu=45,/**< 采集完成播报次数*/
	HX711SystemPara_u32_CaiJiWanChengBoBaoJianGeShiJian=46,/**< 采集完成播报间隔时间*/
	HX711SystemPara_u32_CaiJiWanChengYaoBaiKaiGuanEn=47,/**< 采集完成摇摆开关*/
	HX711SystemPara_u32_LiuSuYiChangBoBaoLeiXing=48,/**< 流速异常播报类型*/
	//
...
typedef struct SystemParaType
{
	...
	//20240813添加“采集完成”时的语音播报方式
	UINT32 u32_CaiJiWanChengBoBaoShengGuangKongEn;/**< 采集完成声光控使能*/
	UINT32 u32_CaiJiWanChengBoBaoCiShu;/**< 采集完成播报次数*/
	UINT32 u32_CaiJiWanChengBoBaoJianGeShiJian;/**< 采集完成播报间隔时间*/
	UINT32 u32_CaiJiWanChengYaoBaiKaiGuanEn;/**< 采集完成播摇摆开关使能*/
	UINT32 u32_LiuSuYiChangBoBaoLeiXing;/**< 流速异常播报类型*/
} gSystemParaType;
//
...
.minWeight=0,/**< 最小量程*/ \
.maxWeight=5000,/**< 最大量程*/ \
.errRange=(float)(2.0),/**< 误差范围*/ \
.isCascade=0,/**< 是否级联 0:不级联 1:master 2~n:slave*/ \
.isLedIndicate=TRUE,/**< 是否LED指示*/ \
.userColorSet={LED_COLOR_GREEN, LED_COLOR_NONE, LED_COLOR_NONE, LED_COLOR_NONE },/**< 配平色1~4*/\
.zeroRange=(float)(5.0),/**< 点范围*/ \
.ScreenVoiceSwitch=1,/**< 语音开关*/\
.ScreenCastMode=0,/**< 级联显示模式*/\
.FlashEraseTimes=0,/**< FLASH 擦写次数*/\
.McuVersion=101,/**< MCU软件版本号*/\
.DiWenVersion=31,/**< 迪文软件版本号*/\
.VoiceNum=30,/**< 语音大小*/\
.VoiceNumTouch=30,/**< 语音大小 触控*/\
.ScreenLight=50,/**< 屏幕背光亮度*/\
.userColorUsed={FALSE, FALSE, FALSE, FALSE },/**< chanel_a<<8 + chanel_b*/\
.motorEn=0,/**< 电机运转使能*/\
.motorDir=0,/**< 电机运转方向*/\
.motorFre=6800,/**< 电机PWM频率*/\
.yusheWeight={200,300,400},/**< 各挡位的预设重量*/\
.u16_ml_g_bilv=1050,/**< ml与g比率*/\
.u16_fmqkqsj=95,/**< 蜂鸣器开始时间*/\
.u16_liusu_high_warn=500,/**< 流速高 报警点*/\
.u16_liusu_low_warn=60,/**< 流速低 报警点*/\
.u16_kaiqi_guanjiafa_gongneng=TRUE,/**< 是否：开启管夹阀功能*/\
.u32_PercentReceipt=5,/**< 屏幕百分比显示的回滞区间*/\
.u32_LevelMinAndMax={{0,0},{0,0},{0,0}},/**< 各挡位的最小值 最大值*/\
.u32_50PerVoicePrintf=FALSE,/**< 50%语音播报*/\
.u32_80PerVoicePrintf=FALSE,/**< 80%语音播报*/\
.u32_90PerVoicePrintf=TRUE,/**< 90%语音播报*/\
.u32_MotorRockFre=FALSE,/**< 电机摇摆频率*/\
.u32_LiuSu_Window=2,/**< 流速窗口：窗口采样宽度*/\
.u32_YaoBaiVlu_TuanCai=80,/**< 摇摆值（团采）*/\
.u32_YaoBaiTime_TuanCai=2,/**< 摇摆时间（团采）*/\
.u32_FastWarnFilterTime=3000,/**< 快速滤波时间*/\
.u32_SlowWarnFilterTime=3000,/**< 慢速滤波时间*/\
.u32_CaiJiWanChengBoBaoShengGuangKongEn=FALSE,/**< 采集完成声光控使能*/\
.u32_CaiJiWanChengBoBaoCiShu=5,/**< 采集完成播报次数*/\
.u32_CaiJiWanChengBoBaoJianGeShiJian=2000,/**< 采集完成播报间隔时间*/\
.u32_CaiJiWanChengYaoBaiKaiGuanEn=1,/**< 采集完成摇摆开关*/\
.u32_LiuSuYiChangBoBaoLeiXing=1,/**< 流速异常播报类型*/\
}
//
