...
/* 硬件端口资源定义 */
// UART1 接扫码枪 , 实际是 STM32F303 UASRT3 , 带DMA功能
...
#define UART1_RX_GPIO_CLK					RCC_AHBENR_GPIOCEN
...
// UART2 接ZHONGXIAN显示屏 , 实际是 STM32F303 UASRT2 , 带DMA功能
...
#define UART2_TX_GPIO_CLK					RCC_AHBENR_GPIOBEN
#define UART2_TX_GPIO_PIN					GPIO_PIN_3
#define UART2_TX_PIN_SOURCE					GPIO_PINSOURCE3

#define UART2_RX_GPIO_PORT					GPIOB
#define UART2_RX_GPIO_CLK					RCC_AHBENR_GPIOBEN
#define UART2_RX_GPIO_PIN					GPIO_PIN_4
#define UART2_RX_PIN_SOURCE					GPIO_PINSOURCE4
...
#define UART2_DEA_GPIO_PIN					GPIO_PIN_2

// UART3 接无线模块 , 实际是 STM32F303 UASRT2 , 带DMA功能
#define UART3_PORT							USART1
#define UART3_PORT_CLK						RCC_APB2ENR_USART1EN
#define UART3_PORT_IRQn						USART1_IRQn
#define UART3_PORT_GPIO_AF					GPIO_AF7_USART1

#define UART3_TX_GPIO_PORT					GPIOC
#define UART3_TX_GPIO_CLK					RCC_AHBENR_GPIOCEN
#define UART3_TX_GPIO_PIN					GPIO_PIN_4
#define UART3_TX_PIN_SOURCE					GPIO_PINSOURCE4

#define UART3_RX_GPIO_PORT					GPIOC
#define UART3_RX_GPIO_CLK					RCC_AHBENR_GPIOCEN
#define UART3_RX_GPIO_PIN					GPIO_PIN_5
#define UART3_RX_PIN_SOURCE					GPIO_PINSOURCE5

#define UART3_TX_DMA						DMA1
#define UART3_TX_DMA_CLK					RCC_AHBENR_DMA1EN
#define UART3_TX_DMA_CHANNEL            	DMA1_Channel4
#define UART3_TX_DMA_IRQn              	 	DMA1_Channel4_IRQn
#define UART3_TX_DMA_IT_TCIF				DMA1_IT_TC4

#define UART3_RX_DMA						DMA1
#define UART3_RX_DMA_CLK					RCC_AHBENR_DMA1EN
#define UART3_RX_DMA_CHANNEL            	DMA1_Channel5

/** 总线使能口线定义 -- not used*/
#define UART3_DEA_GPIO_PORT					GPIOB
#define UART3_DEA_GPIO_CLK					RCC_AHBENR_GPIOBEN
#define UART3_DEA_GPIO_PIN					GPIO_PIN_2

/** 重新定义中断 */
#define uart_smq_isr						USART3_IRQHandler
#define uart_smq_tx_dma_isr					DMA1_Channel2_IRQHandler
#define uart_smq_rx_dma_isr					DMA1_Channel3_IRQHandler

#define uart_zxp_isr						USART2_IRQHandler
#define uart_zxp_tx_dma_isr					DMA1_Channel7_IRQHandler
#define uart_zxp_rx_dma_isr					DMA1_Channel6_IRQHandler

#define uart_wxm_isr						USART1_IRQHandler
#define uart_wxm_tx_dma_isr					DMA1_Channel4_IRQHandler
#define uart_wxm_rx_dma_isr					DMA1_Channel5_IRQHandler
...
extern void drv_gpio_set_pins_high( GpioType *pPort, UINT16 Pins );

extern void hal_uart_set_tx_mode( UartDeviceType *pUartDevice );
extern void hal_uart_set_rx_mode( UartDeviceType *pUartDevice );
